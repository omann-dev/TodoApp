...
export function EditTodoScreen({
  ...
  useEffect(() => {
    ...
    setPlannedForDate(todo.plannedFor);
    ...
    return (
      <View style={styles.container}>
        <View style={styles.content}>
          ...
          <Text style={styles.title}>{t("editTodo.notFound")}</Text>
          <Text style={styles.subtitle}>{t("editTodo.notFoundDescription")}</Text>
        </View>
      </View>
    );
  }
  ...
  const canSaveTodo = isTitleValid && isDateValid;
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.header}>
          ...
          <View style={styles.headerTextContainer}>
            <Text style={styles.title}>{t("editTodo.title")}</Text>
            <Text style={styles.subtitle}>{t("editTodo.subtitle")}</Text>
          </View>
        </View>
        ...
        <Pressable
          style={[
            styles.createButton,
            !canSaveTodo && styles.createButtonDisabled,
          ]}
          onPress={handleSaveTodo}
        >
          <Text style={styles.createButtonText}>{t("editTodo.save")}</Text>
        </Pressable>
      </ScrollView>
    </KeyboardAvoidingView>
  );
